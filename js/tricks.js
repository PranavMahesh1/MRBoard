...
function ConstructToolbar()
{
	...
	[
		...
		{ label: "fa fa-image", title: "Image", insert: "img" },
		{ label: "-" },
		{ label: "fa fa-quote-left", title: "Quote", insert: "quote" },
		{ label: "fa fa-expand", title: "Spoiler", insert: "spoiler" },
		{ label: "fa fa-file-text-o", title: "Insert code block", style: "font-family: monospace", insert: "code" },
