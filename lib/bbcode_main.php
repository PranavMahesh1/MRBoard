...
function cleanUpPost($postText, $poster = "", $noSmilies = false, $noBr = false)
{
	...
	$s = str_ireplace('ysmbmforums.bugs3.com', 'mariomansion.net', $s);
	$s = str_ireplace('ysmbmforums.ddns.net', 'mariomansion.net', $s);
	$s = str_ireplace('lmlair.ddns.net', 'mariomansion.net', $s);
	$s = str_ireplace('mariomansion.net', 'mariomansion.net', $s);
	$s = str_ireplace('http://ysmbmforums.bugs3.com', 'http://mariomansion.net', $s);
	$s = str_ireplace('http://ysmbmforums.ddns.net', 'http://mariomansion.net', $s);
	$s = str_ireplace('http://lmlair.ddns.net', 'http://mariomansion.net', $s);
	$s = str_ireplace('http://mariomansion.net', 'http://mariomansion.net', $s);
