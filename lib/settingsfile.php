...
\");
		...
		"ayahpublisherkey" => array (
			"type" => "text",
			"default" => "",
			"name" => "AYAH Publisher Key",
			'category' => 'Functionality',
			'rootonly' => 1,
		),
		"ayahscoringkey" => array (
			"type" => "text",
			"default" => "",
			"name" => "AYAH Scoring Key",
			'category' => 'Functionality',
			'rootonly' => 1,
		),
		...
		'linksText' => array(
			'type' => 'texthtml',
			'default' => 'Links page Text.',
			'name' => 'Links page contents',
			'category' => 'Links page contents',
		),
	);
?>
