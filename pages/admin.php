...
if ($loguser['root'])						$adminLinks[] = actionLinkTag(__("Manage plugins"), "pluginmanager");
...
if (HasPermission('admin.editsettings'))
{
	...
	$adminLinks[] = actionLinkTag(__("Edit Links Page"), "editsettings", '', 'field=linksText');
}
if (HasPermission('admin.assignbadges'))	$adminLinks[] = actionLinkTag(__("Assign User Badges"), "userbadges");
