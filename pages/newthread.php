...
else if(isset($_POST['actionpost']))
{
	...
	else
	{
		...
		if($lastPost < Settings::get("floodProtectionInterval"))
		{
			...
			$rejected = true;
			Alert(__("You can't post that fast."), __("Hold your horses."));
		}
	}
...
echo "
<center><p>You will gain 1 coin <img src=\"http://fc00.deviantart.net/fs50/f/2009/319/1/6/Mario___Coin_by_anckerboy24.gif\" /> for making this thread.</center></p>
";
echo "
