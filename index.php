...
if ($loguser['flags'] & 0x2)
{
	if (rand(0,100) <= 75)
	{
		Alert("Could not load page: failed to connect to the database. Try again later.", 'Error');
		$fakeerror = true;
	}
}
...
$mobileswitch = '';
if ($mobileLayout) $mobileswitch .= 'Currently on mobile view - ';
if ($_COOKIE['forcelayout']) $mobileswitch .= '<a href="?forcelayout=0" rel="nofollow">Switch to desktop view</a>';
else if ($mobileLayout) $mobileswitch .= '<a href="?forcelayout=-1" rel="nofollow">Force desktop view</a>';
...
$layout_credits = 
'<img src="http://mariomansion.net/img/MMMbanner.png" style="float: left; margin-right: 3px;">
Mario Modding Mansion owned by <a href="http://mariomansion.ddns.net/profile/1-lifemushroom/">LifeMushroom</a><br><a href="/siteinfo/">Site Info</a>';
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php print resourceLink('//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'); ?>">
